...
static int ttyWrite(iop_file_t *file, char *buf, int size)
{
	...
	res = sendto(tty_socket, buf, size, 0, (struct sockaddr *)&dstaddr, sizeof(dstaddr));

	SignalSema(tty_sema);
	return res;
}

iop_device_ops_t tty_functarray = { ttyInit,	  dummy0,	(void *)dummy, (void *)ttyOpen, (void *)ttyClose, (void *)dummy,
				    (void *)ttyWrite, (void *)dummy, (void *)dummy, (void *)dummy,   (void *)dummy,    (void *)dummy,
				    (void *)dummy,    (void *)dummy, (void *)dummy, (void *)dummy,   (void *)dummy };

iop_device_t tty_driver = { ttyname, 3, 1, "TTY via Udp", &tty_functarray };
